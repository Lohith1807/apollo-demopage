...
export default function GlobalDirectory() {
    ...
    const filteredDir = (dirType === 'students' ? directory.students : directory.faculty).filter(u => {
        ...
        const uDept = u.department || u.branch || '';
        const matchesBatch = fBatch ? u.batch === fBatch : true;
        const matchesDept = fDept ? uDept === fDept : true;
        const matchesSpec = fSpec ? u.specialization === fSpec : true;

        return matchesSearch && matchesBatch && matchesDept && matchesSpec;
    });
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500 pb-20">
            ...
            <div className="bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden">
                <div className="px-8 py-6 border-b border-slate-100 bg-slate-50/50 flex flex-col xl:flex-row xl:items-center justify-between gap-6">
                    <div className="flex flex-col md:flex-row md:items-center gap-6">
                        ...
                        <div className="flex flex-wrap items-center gap-3">
                            <select
                                ...
                                className="bg-white border border-slate-200 rounded-xl px-3 py-2 text-[10px] font-black uppercase tracking-widest text-slate-500 focus:ring-2 focus:ring-apollo-red/20 outline-none transition-all shadow-sm"
                            >
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="pl-10 pr-4 py-2 bg-white border border-slate-200 rounded-xl text-xs font-bold outline-none ring-2 ring-transparent focus:ring-apollo-red/20 transition-all w-full md:w-64 shadow-inner"
                        />
                    </div>
                </div>

                        ...
                        {marks.length > 0 ? (
                            <div className="p-4">
                                ...
                                <div className="mt-4 pt-4 border-t border-slate-100 text-center">
                                    {user.role !== 'teacher' && (
                                        <button onClick={() => setMarks([...marks, { course: 'NEW SUBJECT', code: 'SUB', internal: 0, external: 0, total: 0, grade: 'F', semester }])} className="text-[10px] font-black text-slate-400 uppercase tracking-widest hover:text-apollo-red transition-colors">
